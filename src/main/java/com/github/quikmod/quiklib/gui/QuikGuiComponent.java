...
public class QuikGuiComponent<C> {
    ...
    private BiConsumer<QuikGuiComponent<C>, List<String>> tootipAdder;
    private BiFunction<QuikGuiComponent<C>, Point, Boolean> mouseClickAction;
    private BiConsumer<QuikGuiComponent<C>, Point> mouseEnterAction;
    private BiConsumer<QuikGuiComponent<C>, Point> mouseLeaveAction;
    private BiConsumer<QuikGuiWrapper, QuikGuiComponent<C>> renderAction;

    private boolean isVisible = true;
    private boolean isEnabled = true;
    private boolean isHovered = false;

    public QuikGuiComponent(C component, Rectangle bounds, Rectangle uv, double scale, boolean centeredHorizontally, boolean centeredVertically, boolean visable, boolean enabled, BiConsumer<QuikGuiComponent<C>, List<String>> tootipAdder, BiFunction<QuikGuiComponent<C>, Point, Boolean> mouseClickAction, BiConsumer<QuikGuiComponent<C>, Point> mouseEnterAction, BiConsumer<QuikGuiComponent<C>, Point> mouseLeaveAction, BiConsumer<QuikGuiWrapper, QuikGuiComponent<C>> renderAction) {
    ...
    public void setTootipAdder(BiConsumer<QuikGuiComponent<C>, List<String>> tootipAdder) {
        this.tootipAdder = tootipAdder;
    }

    public void setMouseClickAction(BiFunction<QuikGuiComponent<C>, Point, Boolean> mouseClickAction) {
        this.mouseClickAction = mouseClickAction;
    }

    public void setMouseEnterAction(BiConsumer<QuikGuiComponent<C>, Point> mouseEnterAction) {
        this.mouseEnterAction = mouseEnterAction;
    }

    public void setMouseLeaveAction(BiConsumer<QuikGuiComponent<C>, Point> mouseLeaveAction) {
        this.mouseLeaveAction = mouseLeaveAction;
    }

    public void setRenderAction(BiConsumer<QuikGuiWrapper, QuikGuiComponent<C>> renderAction) {
        this.renderAction = renderAction;
    }
    ...
    public final void renderComponent(QuikGuiWrapper gui) {
