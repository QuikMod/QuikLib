...
public final class QuikGuiWrapper extends GuiContainer {

    private final Deque<QuikGui> guis;

    public QuikGuiWrapper(QuikGui gui) {
    ...
    public void pushGui(QuikGui gui) {
        this.guis.add(gui);
        this.xSize = gui.getWidth();
        this.ySize = gui.getHeight();
